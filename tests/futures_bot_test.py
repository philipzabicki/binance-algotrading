...
MARKET = 'um'
INTERVAL = '1m'
position_ratio, stop_loss, enter_at, close_at = 0.5, 0.001, 0.5, 0.5
fast_period, slow_period, signal_period, fast_ma_type, slow_ma_type, signal_ma_type, leverage = 3, 6, 3, 1, 1, 1, 125
