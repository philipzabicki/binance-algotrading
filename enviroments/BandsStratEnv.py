...
class OneRunEnvSpot(BacktestEnvSpot):
  def __init__(self, df, dates_df=None, excluded_left=0, leverage=1, StopLoss=0.0, typeMA=0, MA_period=2, ATR_period=2, ATR_multi=1,
...
class BandsStratEnvSpot(Env):
    def __init__(self, df, df_mark=None, excluded_left=0, init_balance=100_000, postition_ratio=1.0,
        ...
        self.exec_env = OneRunEnvSpot(df, df_mark=df_mark, leverage=1, StopLoss=0.0, typeMA=0, MA_period=2, ATR_period=2, ATR_multi=1,
    ...
    def reset(self, postition_ratio=1.0, leverage=1, StopLoss=0.01, typeMA=0, MA_period=2, ATR_period=2, ATR_multi=1.250):
        ...
        return self.exec_env.reset(postition_ratio, leverage, StopLoss, typeMA, MA_period, ATR_period, ATR_multi)
