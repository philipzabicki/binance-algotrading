...
def get_MA(np_df, type, MA_period):
   ma_types = {0: lambda np_df,period: RMA(np_df[:,3], timeperiod=period),
               ...
               4: lambda np_df,period: talib.KAMA(np_df[:,3], timeperiod=period),
               5: lambda np_df,period: talib.TRIMA(np_df[:,3], timeperiod=period),
               6: lambda np_df,period: talib.DEMA(np_df[:,3], timeperiod=period),
               7: lambda np_df,period: talib.TEMA(np_df[:,3], timeperiod=period),
               8: lambda np_df,period: talib.T3(np_df[:,3], timeperiod=period),
               9: lambda np_df,period: finTA.SMM(pd.DataFrame(np_df, columns=['open','high','low','close','volume','X']), period).to_numpy(),
               10: lambda np_df,period: finTA.SSMA(pd.DataFrame(np_df, columns=['open','high','low','close','volume','X']), period).to_numpy(),
               #12: lambda np_df,period: finTA.VAMA(pd.DataFrame(np_df, columns=['open','high','low','close','volume','X']), period).to_numpy(),
               11: lambda np_df,period: finTA.ZLEMA(pd.DataFrame(np_df, columns=['open','high','low','close','volume','X']), max(4,period)).to_numpy(),
               #14: lambda np_df,period: finTA.EVWMA(pd.DataFrame(np_df, columns=['open','high','low','close','volume','X']), period).to_numpy(),
               12: lambda np_df,period: finTA.SMMA(pd.DataFrame(np_df, columns=['open','high','low','close','volume','X']), period).to_numpy(),
               13: lambda np_df,period: finTA.HMA(pd.DataFrame(np_df, columns=['open','high','low','close','volume','X']), period).to_numpy(),
               14: lambda np_df,period: ALMA(np_df[:,3], timeperiod=period),
               15: lambda np_df,period: HammingMA(np_df[:,3], period),
               16: lambda np_df,period: LSMA(np_df[:,3], max(3,period)),
               17: lambda np_df,period: LWMA(np_df[:,3],  period),
               18: lambda np_df,period: MGD(np_df[:,3], period),
               #22: lambda np_df,period: VAMA(np_df[:,3], np_df[:,4], period),
               19: lambda np_df,period: GMA(np_df[:,3], period),
               20: lambda np_df,period: FBA(np_df[:,3], period),
               21: lambda np_df,period: NadarayWatsonMA(np_df[:,3], period, kernel=0),
               22: lambda np_df,period: NadarayWatsonMA(np_df[:,3], period, kernel=1),
               23: lambda np_df,period: NadarayWatsonMA(np_df[:,3], period, kernel=2),
               24: lambda np_df,period: NadarayWatsonMA(np_df[:,3], period, kernel=3),
               25: lambda np_df,period: NadarayWatsonMA(np_df[:,3], period, kernel=4),
               26: lambda np_df,period: NadarayWatsonMA(np_df[:,3], period, kernel=5),
